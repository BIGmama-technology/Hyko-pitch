...
export default function HeroVideoDialog({
        ...
        >
          ...
          >
            <motion.button
              ...
              onClick={() => setIsVideoOpen(false)} // Add close functionality
            >
  ...
  return (
    <div className={cn("relative", className)}>
      <div
        className="relative cursor-pointer group bg-blue-300"
      ...
      >
        <Image
          ...
          width={16}
          height={9}
          className="w-full mx-auto max-w-4xl transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-md shadow-lg border"
        />
