      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="bg-gray-100">
            ...
            <th className="border p-2 text-left bg-sky-300">
              <img src="/logo_dark.svg" alt="Hyko" className="w-8 h-8 inline-block mr-2" /> Hyko
            </th>
            <th className="border p-2 text-left">
              <img src="/competitors/langflow.svg" alt="LangFlow" className="w-8 h-8 inline-block mr-2" /> LangFlow
            </th>
            <th className="border p-2 text-left">
              <img src="/competitors/8n8.svg" alt="8n8" className="w-8 h-8 inline-block mr-2" /> 8n8
            </th>
            <th className="border p-2 text-left">
              <img src="/competitors/zapier.svg" alt="Zapier" className="w-8 h-8 inline-block mr-2" /> Zapier
            </th>
            <th className="border p-2 text-left">
              <img src="/competitors/make.svg" alt="Make" className="w-8 h-8 inline-block mr-2" /> Make
            </th>
            <th className="border p-2 text-left">
              <img src="/competitors/instill.svg" alt="Instill" className="w-8 h-8 inline-block mr-2" /> Instill
            </th>
            <th className="border p-2 text-left">
              <img src="/competitors/gumloop.svg" alt="Gumloop" className="w-8 h-8 inline-block mr-2" /> Gumloop
            </th>
            <th className="border p-2 text-left">
              <img src="/competitors/mind-studio.svg" alt="Mind studio" className="w-8 h-8 inline-block mr-2" /> Mind studio
            </th>
          </tr>
        </thead>
        <tbody>
