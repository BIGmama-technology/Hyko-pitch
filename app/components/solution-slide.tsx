...
export function SolutionSlide() {
  ...
  return (<div className="grid place-items-center max-w-full items-center    text-blue-600 ">
    <h2 className="text-2xl sm:text-4xl font-bold mb-8">Hyko.ai</h2>
    <ul className="text-xl max-w-[200px] sm:text-2xl md:space-y-6 md:max-w-6xl mx-auto text-left">
