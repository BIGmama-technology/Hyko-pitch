...
export function Groq({ className }: IconProps) {
	return (
		<svg xmlns='http://www.w3.org/2000/svg' aria-label='groq logo' role='img' fill='none' className={className}>
			<title>Groq icon</title>
			<path fill='#F55036' d='M24 12c0 6.627-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0s12 5.373 12 12Z' />
			<path
				fill='#fff'
