	...
	return (
		...
		>
			...
			<radialGradient
				...
				r='70.587'
			>
				<stop offset='.3144' stopColor='#ff9800' />
				<stop offset='.6616' stopColor='#ff6d00' />
				<stop offset='.9715' stopColor='#f44336' />
			</radialGradient>
			<radialGradient
				id='b'
				cx='64.9211'
				...
				r='73.8599'
			>
				<stop offset='.2141' stopColor='#fff176' />
				<stop offset='.3275' stopColor='#fff27d' />
				<stop offset='.4868' stopColor='#fff48f' />
				<stop offset='.6722' stopColor='#fff7ad' />
				<stop offset='.7931' stopColor='#fff9c4' />
				<stop offset='.8221' stopColor='#fff8bd' stopOpacity='.804' />
				<stop offset='.8627' stopColor='#fff6ab' stopOpacity='.529' />
				<stop offset='.9101' stopColor='#fff38d' stopOpacity='.2088' />
				<stop offset='.9409' stopColor='#fff176' stopOpacity='0' />
			</radialGradient>
			<path
