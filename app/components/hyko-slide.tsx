export function HykoSlide() {
  ...
  return (
    <div className="grid justify-center justify-items-center items-center md:grid-cols-3 sm:grid-cols-2 grid-col-1 gap-3  max-h-[75vh] sm:max-h-[80vh] overflow-y-scroll px-4">
      {gifs.map((gif, idx) => (
